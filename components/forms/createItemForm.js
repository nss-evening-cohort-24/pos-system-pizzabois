...
const createItemForm = (uid, obj = {}) => {
  ...
  const domString = `
  <form id="${obj.firebaseKey ? `item-card-edit-btn--${obj.firebaseKey}` : 'item-submit'}">
  ...
  <button type="submit" class="btn btn-success" id="item-form-submit-btn">Add/Edit Item</button>
</form>
  `;
